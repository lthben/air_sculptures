...
const int PM25band1 = 50, PM25band2 = 50, CO2band1 = 50, CO2band2 = 50, VOCband1 = 50, VOCband2 = 50; //num of pixels per strip. Each pixel is 10cm.
...
CRGB leds0[BAND1], leds1[BAND2];
#define UPDATES_PER_SECOND 100 //speed of light animation

int brightness1, brightness2; //band brightness
